...
FILE *p;
clrscr();
printf("ENTER YOUR RETIRED MONTH=");
scanf("%d",&r_m);
printf("\n\nENTER YOUR RETIRED YEAR=");
scanf("%d",&r_y);
p=fopen("X_retired.txt","w");
if(o==1)
{
if(b>=1993 )
{
...
{
nb1= basicsal(b,c,10,1992,o);
nb2=basicsal(b,c,10,1993,o) ;
qw=nb2-nb1;
if(qw==0)
{qw=560;}
}
}
else if(b<1992 && b>=1976)
{
nb1= basicsal(b,c,10,1992,o);
nb2=basicsal(b,c,10,1993,o) ;
qw=nb2-nb1;
...
a5=aspa(asap[cv],a5);
 ...
 if(r_y<2010)
retired(p);
else if(r_y==2010 && r_m<1)
retired(p);
else
{

	i=(basic+a6+a5)*0.4554;
